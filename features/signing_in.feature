Feature: Signing in
  ...
  Scenario: Unsuccesful sign in as a guest
    Given a visitor has an invitation to calendar
    And has entered guests sign up info
    When he clicks sign in
    Then he should see error messages
    And be able to re-fill sign in form


  Scenario: Succesful sign in as a guest
    Given a visitor has an invitation to calendar
    And has entered guests sign up info
    When he clicks sign in
    He should see the calendar he was invited to
